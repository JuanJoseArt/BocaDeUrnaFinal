...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		mnSistema.setBackground(new Color(255, 255, 128));
		...
		JMenu mnAdministracin = new JMenu("AdministraciÃ³n");
		mnAdministracin.setBackground(new Color(255, 255, 128));
		...
		mnProceso.setBackground(new Color(255, 255, 128));
		...
		desktopPane.setBackground(new Color(0, 255, 0));
